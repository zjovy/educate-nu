...
function App() {
  ...
  return (
    <div> 
      {!loggedIn && <div className="bg-[#272635] min-h-screen flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col space-y-4 mt-8">
          ...
          {showLogin && <Login setUserID={setUserID} setUserType={setUserType} setUserName={setUserName} setShowLogin={setShowLogin} setLoggedIn={setLoggedIn}/>}
        </div>
      </div>}
